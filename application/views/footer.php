<footer>
    ...
    <div class="row well no_margin_left">
		...
		<div class="span3">
            <h4>Follow us</h4>
            <ul>
                <li><a href="https://www.twitter.com/noczero">Twitter</a></li>
				<li><a href="https://www.facebook.com/echo.satrya">Facebook</a></li>
            </ul>
        </div>
        <div class="span2">
            <h4>My Account</h4>
    ...
    <p class="pull-right">
        Copyright by : <a href="http://zeroonetm@gmail.com" rel="dofollow"/>Zero-Inside</a>
