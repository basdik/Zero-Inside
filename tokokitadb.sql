...
MySQL - 5.5.24-log : Database - Zero-Insidedb
*********************************************************************
*/
...
CREATE DATABASE /*!32312 IF NOT EXISTS*/`Zero-Insidedb` /*!40100 DEFAULT CHARACTER SET latin1 */;
...
insert  into `settings`(`id`,`key`,`value`,`description`) values (1,'paginationLimit','6','Global pagination limit'),(2,'imageAllowed','gif|jpg|png|jpeg',''),(3,'maxImageSize','200000',''),(4,'Order.DueDate','7','Days payment due'),(5,'Bank.Name','BCA,Mandiri,BNI','Bank name that receive transfer from customer'),(6,'Email.Admin','admin@Zero-Inside.com','Email Admin');
